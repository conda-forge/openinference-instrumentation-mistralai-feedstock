About openinference-instrumentation-mistralai-feedstock
=======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openinference-instrumentation-mistralai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openinference-instrumentation-mistralai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openinference-instrumentation-mistralai
# for installing globally
pixi global install openinference-instrumentation-mistralai
```
...
It is possible to list all of the versions of `openinference-instrumentation-mistralai` available on your platform:
...
```
pixi search openinference-instrumentation-mistralai --channel conda-forge
```
